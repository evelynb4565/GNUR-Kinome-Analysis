...
experiment_ID <- "Dr_Stec_RNAi_Ugt1a1_v_RNAi_VEH_PTK"
...
kinases_of_interest <-c("ZAP70", "Syk", "FRK", "BLK", "Brk", "Src", "LTK", "Ron", "HER3", "Tyro3/Sky", "Ret", "Met", "Srm", "Fes", "HCK", "BTK", "IGF1R", "HER4", "FGFR1", "RYK", "Arg", "Yes", "Lck", "Abl", "HER2")
...
png(file = (paste0(EAB_directory_output_comparison_families, "Fig1-SYK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "SYK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig2-TRK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "TRK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig3-ACK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "ACK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig4-SRC","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "SRC")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig5-TEC","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "TEC")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig6-RYK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "RYK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig7-ABL","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "ABL")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig8-DDR","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
...
mapped_lfc_table %>% 
  # choose kinase to plot
  filter(Kin %in% kinases_of_interest[15:16]) %>% 
  krsa_waterfall(0.2) +
  facet_wrap(~Kin, scales = "free_y")

mapped_lfc_table %>% 
  # choose kinase to plot
  filter(Kin %in% kinases_of_interest[17:18]) %>% 
  krsa_waterfall(0.2) +
  facet_wrap(~Kin, scales = "free_y")

mapped_lfc_table %>% 
  # choose kinase to plot
  filter(Kin %in% kinases_of_interest[19:20]) %>% 
  krsa_waterfall(0.2) +
  facet_wrap(~Kin, scales = "free_y")

mapped_lfc_table %>% 
  # choose kinase to plot
  filter(Kin %in% kinases_of_interest[21:22]) %>% 
  krsa_waterfall(0.2) +
  facet_wrap(~Kin, scales = "free_y")

mapped_lfc_table %>% 
  # choose kinase to plot
  filter(Kin %in% kinases_of_interest[23:24]) %>% 
  krsa_waterfall(0.2) +
  facet_wrap(~Kin, scales = "free_y")

mapped_lfc_table %>% 
  # choose kinase to plot
  filter(Kin %in% kinases_of_interest[25]) %>% 
  krsa_waterfall(0.2) +
  facet_wrap(~Kin, scales = "free_y")
...
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, c("ZAP70", "Syk", "FRK", "BLK", "Brk", "Src", "LTK", "Ron", "HER3", "Tyro3/Sky", "Ret", "Met", "Srm", "Fes", "HCK", "BTK", "IGF1R", "HER4", "FGFR1", "RYK", "Arg", "Yes", "Lck", "Abl", "HER2"))

png(file = (paste0(EAB_directory_output_comparison, "Fig1-ZAP70","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "ZAP70")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig2-Syk","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Syk")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig3-FRK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "FRK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig4-BLK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "BLK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig5-Brk","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Brk")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig6-Src","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Src")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig7-LTK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "LTK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig9-Ron","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Ron")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig10-HER3","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "HER3")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig11-Tyro3-Sky","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Tyro3/Sky")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig12-Ret","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Ret")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig13-Met","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Met")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig14-Srm","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Srm")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig15-Fes","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Fes")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig16-BTK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "BTK")
dev.off()
...
png(file = (paste0(EAB_directory_output_comparison, "Fig18-HCK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "HCK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig19-IGF1R","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "IGF1R")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig20-HER4","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "HER4")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig21-RYK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "RYK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig22-Yes","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Yes")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig23-Lck","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "HER4")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig24-Abl","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Abl")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig25-HER2","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "HER2")
dev.off()
```
